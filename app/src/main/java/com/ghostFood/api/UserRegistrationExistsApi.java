 ...
 */
public interface UserRegistrationExistsApi {
    @FormUrlEncoded
    @POST("user/exists")
    Call<ResponseUserRegistrationExists> Exists(@Field("registration_type") Integer mRegistrationType, @Field("extra_variable1") String mExtraCariable1,
                              @Field("device_token") String mDeviceToken, @Field("device_type_id") String mDeviceTypeId);

    public class ResponseUserRegistrationExists {
